...
<%
  ...
  if (success) {
    ...
    response.sendRedirect("/IMS/manage-issue"); // Replace "success.jsp" with the appropriate success page path
  } else {
    // Redirect the user to an error page
    response.sendRedirect("/IMS/error"); // Replace "error.jsp" with the appropriate error page path
  }
%>
