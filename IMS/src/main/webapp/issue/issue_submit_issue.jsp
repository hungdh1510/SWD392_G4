...
<%
  ...
  if (success) {
    ...
    response.sendRedirect("/IMS/manage-issue"); // Replace "view_issue.jsp" with the appropriate success page
  } else {
    // Redirect the user to an error page or display an error message
    response.sendRedirect("/IMS/error"); // Replace "error.jsp" with the appropriate error page
  }
%>